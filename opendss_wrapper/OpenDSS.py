...
ELEMENT_CLASSES = {
    ...
    'Source': dss.Vsources,     # Added by RAVI TEJA
}
...
class OpenDSS:
    ...
    ################# Function Written By RAVI TEJA  #####################
    def set_source_voltage(self,id,voltage):
        dss.Vsources.Idx(id)        # Activating the source for source voltage setting
        dss.Vsources.PU(voltage)
    ...
    ###########  Function Written by RAVI TEJA  ##############
    def get_source_power(self,name,element):
        self.set_element(name, "Source")
        return dss.CktElement.TotalPowers()
